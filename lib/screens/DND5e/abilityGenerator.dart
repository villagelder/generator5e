...
class _ListViewerState extends State<ListViewer> {
  ...
  Map<String, int> diceRollsMap = {};
  List<String> diceRollsList = ["Dice Rolls"];
  AbilityScoreGenerator asg5e = AbilityScoreGenerator();

  updateList() {
    diceRollsList = asg5e.generateDiceRolls(_MethodDDBState.methodValue);
